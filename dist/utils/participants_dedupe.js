...
exports.collapseDuplicateParticipants = collapseDuplicateParticipants;
function collapseDuplicateParticipants(summary) {
    ...
    const normalized = sections.map((sec) => {
        ...
        const filtered = lines.filter((_, idx) => {
            if (idx === keepIndex)
                return true;
            if (participantIndices.includes(idx))
                return false;
            return true;
        });
...
exports.default = collapseDuplicateParticipants;
